...
- TCMB, TEFAS ve Yahoo Finance keyless/public kaynak olarak çalışır; kullanıcıdan API key/base URL istenmez.
...
- TCMB ve Yahoo Finance için API key/base URL gerekmez.
