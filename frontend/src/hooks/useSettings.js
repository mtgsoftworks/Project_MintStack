...
export function useCurrency() {
    ...
    return {
        currency,
        rates: currentRates,
        format: (amount, options = {}) => formatCurrency(amount, currency, { ...options, rates: currentRates }),
        formatAs: (amount, targetCurrency, options = {}) => formatCurrency(amount, targetCurrency, { ...options, rates: currentRates }),
...
export function useDateTime() {
    ...
    return {
        timezone,
        formatDate: (date, options = {}) => formatDate(date, timezone, options),
        formatDateTime: (date, options = {}) => formatDateTime(date, timezone, options),
        formatTime: (date, options = {}) => formatTime(date, timezone, options),
