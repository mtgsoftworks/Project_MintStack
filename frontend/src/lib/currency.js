 ...
 */
export function calculateRatesFromTCMB(currencies) {
 ...
 */
export function formatCurrency(amount, targetCurrency = 'TRY', options = {}) {
 ...
 */
export function formatNumber(num, decimals = 2, locale = 'tr-TR') {
 ...
 */
export function convertCurrency(amount, from = 'TRY', to = 'TRY', rates = null) {
